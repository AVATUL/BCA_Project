...
<form name="adm" method="post"/>
	...
	<center>
		...
		<input type="text" name="id" style= "width:600" placeholder="imput the NOTICE ID to delete"/></br></br></br>
			<input type="submit" name="submit" value="Delete Notice" style= width:600/>
...
if(isset($_POST['submit']))
	{
		...
		{
			echo"<script>alert('Your notice has been successfully deleted')</script>";
			header("Refresh:1; url=admhome.php");
		}
		else
		{
			echo"<Script>alert('incorrect Notice Id please try again')</script>";
